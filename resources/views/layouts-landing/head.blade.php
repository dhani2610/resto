 <meta charset="utf-8">
  ...
  <!-- Favicons -->
  <link href="{{ asset('fe/assets/img/TepiDanauBistro_Logo_-removebg.png')}}" rel="icon">
  <link href="{{ asset('fe/assets/img/TepiDanauBistro_Logo_-removebg.png')}}" rel="apple-touch-icon">
